...
#include "amtp_alarm.hpp"
#include "../../../amtpa_protocol/amtpap_msg.pb.h"

amtp_alarm::amtp_alarm()
{
...
unique_ptr<JwumqMessage> amtp_alarm::data(ALARM_STRU * s, unsigned char *token, LIC_CONF_T load_conf, uint32_t sn, string src_id, string des_id)
{
	amtpap::AlarmV1 req;
	...
	req.set_reason_code(s->reason_code);
	...
	cmdprimitive.set_msg_id(amtpap::MsgID::ALARM_V1);
