...
#include "amtp_query_data_resp.hpp"
#include "../../../amtpa_protocol/amtpap_msg.pb.h"

amtp_query_data_resp::amtp_query_data_resp()
{
...
unique_ptr<JwumqMessage> amtp_query_data_resp::data(QUERY_DATA_RESP_STRU * s, unsigned char *token, LIC_CONF_T load_conf, uint32_t sn, string src_id, string des_id)
{
	amtpap::QueryDataRespV1 resp;
	...
	cmdprimitive.set_msg_id(amtpap::MsgID::QUERY_DATA_RESP_V1);
