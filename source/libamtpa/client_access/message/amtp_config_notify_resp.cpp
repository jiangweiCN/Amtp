...
#include "amtp_config_notify_resp.hpp"
#include "../../../amtpa_protocol/amtpap_msg.pb.h"

amtp_config_notify_resp::amtp_config_notify_resp()
{
...
unique_ptr<JwumqMessage> amtp_config_notify_resp::data(CONFIG_NOTIFY_RESP_STRU * s, unsigned char *token, LIC_CONF_T load_conf, uint32_t sn, string src_id, string des_id)
{
	...
	cmdprimitive.set_msg_id(amtpap::MsgID::CONFIG_NOTIFY_RESP_V1);
